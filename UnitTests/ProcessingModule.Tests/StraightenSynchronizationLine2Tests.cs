...
namespace ProcessingModule.Tests
{
    public class StraightenSynchronizationLine2Tests
    {
        public ICmpScan GetCmpScan1()
        {
            ...
            var ascan1 = new double[] { 0, 3, 4, 5, 0, 0, -2, -1 };
            var ascan2 = new double[] { 0, 4, 0, 1, -1, 0, -3, -4 };
            var ascan3 = new double[] { 2, 2, 2, -7, -8, -7, -5 };
        ...
        public void AscansMove()
        {
            ...
            Assert.Equal(5, cmpScan.Data[0][3]);
            Assert.Equal(4, cmpScan.Data[1][3]);
            Assert.Equal(2, cmpScan.Data[2][3]);
            Assert.Equal(2, cmpScan.Data[2][2]);
